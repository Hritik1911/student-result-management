...
<div id="non-printable">
    ...
    <p ><small>CREATED BY ARADHANA TRIAPTHY</small></p>
    ...
    if($num_rows>0)
    {
        while($row=mysqli_fetch_array($res))
        {
           ...
           echo "<tr>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in ED:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['maths'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in CL & E:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['english'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in RPG:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['phy'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in SPM:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['dsa'];
            echo "</td>";
